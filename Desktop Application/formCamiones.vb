                ...
                If MsgBox(Mensaje, CType(MsgBoxStyle.Exclamation + MsgBoxStyle.YesNo, MsgBoxStyle), My.Application.Info.Title) = MsgBoxResult.Yes Then
                    ...
                    Try
                        Using dbContext = New CSPesajeContext(True)
                            ...
                            CamionActual = dbContext.Camion.Find(CType(datagridviewMain.SelectedRows(0).DataBoundItem, Camion).IDEntidad, CType(datagridviewMain.SelectedRows(0).DataBoundItem, Camion).IDCamion)
