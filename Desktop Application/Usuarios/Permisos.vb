...
#Region "Asignación de permisos comunes"
    ...
    Friend Sub CargarArbolDePermisos(ByRef Arbol As TreeView, ByVal IDUsuarioGrupo As Byte)
        ...
        AgregarNodos(nodeParent, PRODUCTOPLANTA, "Productos", PRODUCTOPLANTA_AGREGAR, DESCRIPCION_AGREGAR, PRODUCTOPLANTA_EDITAR, DESCRIPCION_EDITAR, PRODUCTOPLANTA_ELIMINAR, DESCRIPCION_ELIMINAR)
        AgregarNodos(nodeParent, PRODUCTOCOSECHA, "Productos", PRODUCTOCOSECHA_AGREGAR, DESCRIPCION_AGREGAR, PRODUCTOCOSECHA_EDITAR, DESCRIPCION_EDITAR, PRODUCTOCOSECHA_ELIMINAR, DESCRIPCION_ELIMINAR)
