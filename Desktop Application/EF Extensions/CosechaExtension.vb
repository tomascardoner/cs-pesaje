Partial Public Class Cosecha

    Public ReadOnly Property IDCosechaFormatted As String
        Get
            If IDCosecha = 0 Then
                Return My.Resources.STRING_ITEM_EMPTY_MALE
            Else
                Return IDCosecha.ToString(CardonerSistemas.Constants.FormatStringToNumberInteger)
            End If
        End Get
    End Property
